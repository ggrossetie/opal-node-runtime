...
Opal.modules["open-uri"] = function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $hash2 = Opal.hash2, $klass = Opal.klass, $send2 = Opal.send2;
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$initialize', $HTTPError_initialize$8 = function $$initialize(message, io) {
        ...
        $send2(self, Opal.find_super_dispatcher(self, 'initialize', $HTTPError_initialize$8, false, true), 'initialize', [message, io], null);
        return (self.io = io);
