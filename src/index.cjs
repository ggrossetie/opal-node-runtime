  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$module_eval', $Module_module_eval$47 = function $$module_eval($a) {
      ...
      args = $post_args;      if ($truthy((function() {if ($truthy(($ret_or_5 = block['$nil?']()))) {
        ...
        }        $b = [].concat(Opal.to_a(args)), (string = ($b[0] == null ? nil : $b[0])), (file = ($b[1] == null ? nil : $b[1])), (($b[2] == null ? nil : $b[2])), $b;
...
Opal.modules["corelib/array"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$to_h', $Array_to_h$105 = function $$to_h() {
      ...
      if ($iter) $Array_to_h$105.$$p = null;      array = self;
      if ((block !== nil)) {
    ...
    Opal.def(self, '$transpose', $Array_transpose$106 = function $$transpose() {
      ...
      $send(self, 'each', [], ($$107 = function(row){var self = $$107.$$s == null ? this : $$107.$$s, $$108, $ret_or_5 = nil;
        ...
        if ($truthy((row.length)['$!='](max))) {
          self.$raise($$($nesting, 'IndexError'), "" + "element size differs (" + (row.length) + " should be " + (max) + ")");}        return $send((row.length), 'times', [], ($$108 = function(i){$$108.$$s == null ? this : $$108.$$s; var entry = nil, $ret_or_6 = nil, $writer = nil;
    ...
    Opal.def(self, '$instance_variables', $Array_instance_variables$117 = function $$instance_variables() {
      ...
      return $send($send2(self, Opal.find_super_dispatcher(self, 'instance_variables', $Array_instance_variables$117, false, true), 'instance_variables', $zuper, $iter), 'reject', [], ($$118 = function(ivar){$$118.$$s == null ? this : $$118.$$s; var $ret_or_8 = nil;
    ...
    Opal.def(self, '$round', $Number_round$57 = function $$round(ndigits) {
      ...
      if ($truthy($$($nesting, 'Integer')['$==='](self))) {
        ...
        if ($truthy($rb_le(ndigits, 0))) {
          ...
          return self}        $b = $$($nesting, 'Math').$frexp(self), $a = Opal.to_ary($b), (($a[0] == null ? nil : $a[0])), (exp = ($a[1] == null ? nil : $a[1])), $b;
...
Opal.modules["corelib/range"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$each', $Range_each$4 = function $$each() {
      var $iter = $Range_each$4.$$p, block = $iter || nil, $$5, self = this, current = nil, last = nil, $ret_or_4 = nil;
    ...
    Opal.def(self, '$size', $Range_size$12 = function $$size() {
      ...
      range_end = self.end;
      if ($truthy(self.excl)) {
        range_end = $rb_minus(range_end, 1);}      if ($truthy((function() {if ($truthy(($ret_or_9 = $$($nesting, 'Numeric')['$==='](range_begin)))) {
    ...
    Opal.def(self, '$step', $Range_step$13 = function $$step(n) {
      ...
      if (($yield !== nil)) ; else {
        return $send(self, 'enum_for', ["step", n], ($$14 = function(){$$14.$$s == null ? this : $$14.$$s;
      ...
      if ($truthy(self.begin.$$is_number && self.end.$$is_number)) {
        ...
        $send(self, 'each_with_index', [], ($$16 = function(value, idx){$$16.$$s == null ? this : $$16.$$s;
...
Opal.modules["opal/regexp_anchors"] = function(Opal) {
  Opal.top; var $nesting = [], nil = Opal.nil; Opal.$$$; var $$ = Opal.$$, $module = Opal.module;
...
Opal.modules["nodejs"] = function(Opal) {
  var self = Opal.top, $nesting = []; Opal.nil; Opal.$$$; Opal.$$; var $module = Opal.module;
