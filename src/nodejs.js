...
Opal.modules["nodejs/io"] = function(Opal) {
  ...
  var TMP_7, TMP_8, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.const_get_qualified, $$ = Opal.const_get_relative, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $truthy = Opal.truthy, $gvars = Opal.gvars, $lambda = Opal.lambda, $send = Opal.send, $writer = nil;

  Opal.add_stubs(['$node_require', '$attr_reader', '$write', '$read', '$size', '$to_enum', '$chomp', '$each_line', '$write_proc=', '$-', '$tty=']);
...
;
  ...
  $writer = [$lambda((TMP_7 = function(string){var self = TMP_7.$$s || this;
if (string == null) string = nil;
  ...
  $writer = [$lambda((TMP_8 = function(string){var self = TMP_8.$$s || this;
if (string == null) string = nil;
