...
(function(Opal) {
  var self = Opal.top, $scope = Opal, $scopes = [Opal], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2;

  Opal.add_stubs(['$raise', '$delete']);
  return (function($base, $visibility_scopes) {
    var $Base64, self = $Base64 = $module($base, 'Base64');

    var def = self.$$proto, $scope = self.$$scope, $scopes = $visibility_scopes.slice().concat($scope), TMP_Base64_decode64_1, TMP_Base64_encode64_2, TMP_Base64_strict_decode64_3, TMP_Base64_strict_encode64_4, TMP_Base64_urlsafe_decode64_5, TMP_Base64_urlsafe_encode64_6;
    ...
    encode = Opal.global.btoa || function (input) {
      ...
      for (
        ...
        if (charCode > 0xFF) {
          self.$raise(Opal.const_get($scopes, 'ArgumentError', true, true), "invalid character (failed: The string to be encoded contains characters outside of the Latin1 range.)");
        }
    ...
    decode = Opal.global.atob || function (input) {
      ...
      if (str.length % 4 == 1) {
        self.$raise(Opal.const_get($scopes, 'ArgumentError', true, true), "invalid base64 (failed: The string to be decoded is not correctly encoded.)");
      }
      /* jshint ignore:start */
      for (
  ...
  ;
    ...
    Opal.defs(self, '$urlsafe_encode64', TMP_Base64_urlsafe_encode64_6 = function $$urlsafe_encode64(string, $kwargs) {
      ...
      if (padding !== false && padding !== nil && padding != null) {
        } else {
        str = str.$delete("=")
      };
      return str;
